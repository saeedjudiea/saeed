...
const posts = [
  {
    ...
    description: `Rawaf is the leading property classifieds website in the KSA, connecting buyers, investors, landlords, sellers, tenants, and brokers to facilitate various real estate requirements in a seamless, user-friendly manner. Rawaf is a market leader known for going above and beyond.`,
    date: 'Mar 16, 2022',
  ...
  },
  {
    ...
    category: { name: 'Web Application', href: '#' },
    description: `AqarSass is a platform where you can get all real state news. It gets all its information from the Ministry of Justice.`,
    date: 'Sep 16, 2021',
    technologies: ['React', 'Tailwind'],
    postion: 'Technical Team Lead ',
  ...
  },
  {
    ...
    href: '#',
    category: { name: 'Web Application', href: '#' },
    description: `F charity was simple inventory management software designed to manage donors, beneficiaries, inventory, and employees. And printed out every in or out to the stock and kept historical data for analysis and tracking.`,
    date: 'Mar 01, 2016',
    technologies: ['React', 'Tailwind'],
  ...
  },
  {
    ...
    href: '#',
    category: { name: 'Web Application', href: '#' },
    description: `Created Task management tool where you could create and manage projects, tasks and
...
function App() {
  return (
    <div className="App text-center">
      <div className="relative bg-warm-gray-50 px-6 pt-16 pb-20 lg:px-8 lg:pt-16 lg:pb-28">
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="text-center">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-[#455f70] sm:text-4xl mb-2">
              Saeed Judia Al Judia
            </h2>
            ...
            <blockquote className="text-xl italic font-semibold text-gray-900 dark:text-white">
              ...
              <p className="text-gray-400 text-sm ">
                A self-motivated, hardworking, and ambitious individual with a
                great passion for technology. I have excellent communication
                skills, enabling me to communicate effectively with a wide range
                of people. I enjoy improving my skills and abilities in
                different areas, I am a fast Learner, and I have the ability to
                work under pressure.
              </p>
            </blockquote>
            ...
            <div className="flex justify-center items-center flex-wrap space-x-2 my-3">
              {/* <!-- Linkedin --> */}
              <a
                href="https://linkedin.com/in/saeed-judia"
                className="inline-block px-6 py-2.5 mb-2 bg-[#0077b5] text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
              ...
              {/* <!-- Twitter --> */}
              <a
                href="https://twitter.com/ss201ss"
                className="inline-block px-6 py-2.5 mb-2 bg-[#1da1f2] text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
              ...
              {/* <!-- Whatsapp --> */}
              <a
                href="https://wa.me/00966555120065"
                className="inline-block px-6 py-2.5 mb-2 bg-[#128c7e] text-white font-medium text-xs leading-tight uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 448 512"
            ...
            {/* <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
             <svg
                    className="absolute bottom-full left-full translate-y-3/3 -translate-x-2/3 transform xl:bottom-auto xl:top-0 xl:translate-y-0"
                    width={404}
                    height={300}
                    fill="none"
                    viewBox="0 0 404 384"
...
<div className=' bg-[#455f70] p-6 rounded-lg'>

          <h1 className=" mt-9 mb-3 flex items-center  text-3xl font-extrabold text-white ">
            Projects
            <small class="ml-2 font-semibold text-sm text-white">
              other project will be added soon
            </small>
          </h1>
          <div className="flex overflow-x-scroll pb-10 hide-scroll-bar">
            <div className="flex flex-nowrap  lg:ml-25 md:ml-20 ml-10 ">
              {posts.map((post) => (
                <div
                  key={post.title}
                ...
                >
                  <div className="  h-full grid ">
                    ...
                    <div className="flex flex-1 flex-col justify-between p-6 h-auto">
                      <div className="flex-1 ">
                        <p className="text-sm font-medium  inline-block w-fit">
                    ...
                    <p className="">
                      {post.category.name}
                        ...
                        <a href={post.href} className="mt-2 block">
                          ...
                          <p className="mt-3 text-base text-justify text-white">
                            {post.description}
                          </p>
                        </a>
                      </div>
          ...
          <div
            className=" text-left flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 mt-9"
            role="alert"
          >
            <svg
              aria-hidden="true"
